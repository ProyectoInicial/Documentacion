package com.loam.framework.core.customer.restservice.exception;
...
import com.loam.framework.core.customer.restservice.common.ErroresComunes;
...
//        ex.getSupportedMediaTypes().forEach(t -> builder.append(t + " "));
    ...
    public ResponseEntity<Object> handleAll(final CustomHandlerException ex, final WebRequest request) {
        ...
        logger.error("error", ex);
    		...
    		headerResponse.setId(String.valueOf(ex.getIdMensage()));
    		headerResponse.setEstatus(ex.getEstatusMensage());
    		headerResponse.setMensaje(ex.getMessage());
    		
    		estadoRespuesta.setIdOperacion(String.valueOf(ex.getCause().hashCode()));
    		estadoRespuesta.setClase(ex.getStackTrace()[0].getClassName());
    		estadoRespuesta.setMensajeDetallado(ex.getCause().toString());
    		estadoRespuesta.setMetodo(ex.getStackTrace()[0].getMethodName());
