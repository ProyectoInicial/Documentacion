...
import com.loam.framework.core.customer.jaxb.ws.common.excepciongeneral.ObjectFactory;
...
public class CustomSoapFaultMappingExceptionResolver extends SoapFaultMappingExceptionResolver {
	...
	private JAXBContext context;
		...
		public CustomSoapFaultMappingExceptionResolver() throws JAXBException {
			super();
			context = JAXBContext.newInstance("com.loam.framework.core.customer.jaxb.ws.common.excepciongeneral");
		}
