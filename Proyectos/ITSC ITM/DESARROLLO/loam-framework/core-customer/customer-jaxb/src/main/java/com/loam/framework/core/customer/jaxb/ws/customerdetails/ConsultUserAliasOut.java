 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="UserAlias" type="{http://www.loam.com/framework/core/customer/jaxb/ws/CustomerDetails}UserAlias" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ConsultUserAliasOut")
public class ConsultUserAliasOut {

    @XmlElement(name = "TotalRegs")
    protected Long totalRegs;
    @XmlElement(name = "UserAlias", required = true)
    protected List<UserAlias> userAlias;
    ...
    public List<UserAlias> getUserAlias() {
        if (userAlias == null) {
            userAlias = new ArrayList<UserAlias>();
        }
