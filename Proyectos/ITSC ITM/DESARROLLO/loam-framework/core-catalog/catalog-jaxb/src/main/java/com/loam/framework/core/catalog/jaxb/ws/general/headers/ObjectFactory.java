 ...
 * generated in the com.loam.framework.core.catalog.jaxb.ws.general.headers package. 
...
public class ObjectFactory {
    ...
    private final static QName _HeaderRes_QNAME = new QName("http://www.loam.com/framework/core/catalog/jaxb/ws/general/Headers", "HeaderRes");
    private final static QName _HeaderReq_QNAME = new QName("http://www.loam.com/framework/core/catalog/jaxb/ws/general/Headers", "HeaderReq");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.loam.framework.core.catalog.jaxb.ws.general.headers
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.loam.com/framework/core/catalog/jaxb/ws/general/Headers", name = "HeaderRes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.loam.com/framework/core/catalog/jaxb/ws/general/Headers", name = "HeaderReq")
