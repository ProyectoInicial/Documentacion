 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="CatalogColor" type="{http://www.loam.com/framework/core/catalog/jaxb/ws/CatalogManager}CatalogColor" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ConsultCatalogColorOut")
public class ConsultCatalogColorOut {

    @XmlElement(name = "TotalRegs")
    protected Long totalRegs;
    @XmlElement(name = "CatalogColor", required = true)
    protected List<CatalogColor> catalogColor;
     ...
     * This is why there is not a <CODE>set</CODE> method for the catalogColor property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCatalogColor().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CatalogColor> getCatalogColor() {
        if (catalogColor == null) {
            catalogColor = new ArrayList<CatalogColor>();
        }
