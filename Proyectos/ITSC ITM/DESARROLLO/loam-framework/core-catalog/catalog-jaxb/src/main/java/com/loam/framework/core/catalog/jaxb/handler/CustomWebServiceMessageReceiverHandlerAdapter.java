package com.loam.framework.core.catalog.jaxb.handler;
...
import com.loam.framework.core.catalog.jaxb.exception.CodigosError;
	    	...
	    	if(ex.getMessage() != null){
		      errorXml = String.format(
		                 "<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\">"
		                         +"          <ns2:HeaderRes fechaHora=\""+new Date()+"\" xmlns:ns2=\"http://www.loam.com/framework/core/catalog/jaxb/ws/general/Headers\">"
		                         +"          <Id>-3</Id>"
		                         ...
		                         +"			   <detail>"
		                         +"            		<ns3:Excepcion xmlns:ns3=\"http://www.loam.com/framework/core/catalog/jaxb/ws/common/ExcepcionGenericaType\">"
