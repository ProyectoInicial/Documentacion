...
public class CatalogCoinOperations {
	public static String getResponse(List<CatalogCoin> consultarCatalogoMonedaOut) {
	...
	public static String getResponseObj(CatalogCoin catalogoMonedaOut) {
		String cadResponse = null;
		Map<String, Object> message = new HashMap<String, Object>();
