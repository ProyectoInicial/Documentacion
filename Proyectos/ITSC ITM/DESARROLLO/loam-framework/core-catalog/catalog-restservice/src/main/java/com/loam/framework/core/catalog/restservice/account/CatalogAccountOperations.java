...
public class CatalogAccountOperations {
	public static String getResponse(List<CatalogAccount> consultarCatalogoCuentaOut) {
		...
		message.put("data", consultarCatalogoCuentaOut);
		message.put("total", consultarCatalogoCuentaOut.size());
	...
	public static String getResponseObj(CatalogAccount catalogoCuentaOut) {
		String cadResponse = null;
		Map<String, Object> message = new HashMap<String, Object>();
		...
		json1.put("headerResponse", CommonRestOperations.headerResponseExito());
		json1.put("dataResult", message);
		message.put("data", catalogoCuentaOut);
		message.put("total", 1);
		ObjectMapper mapper = new ObjectMapper();
		try {
			cadResponse = mapper.writeValueAsString(json1);
