...
public class CatalogSubCategoryOperations {
	public static String getResponse(List<CatalogSubCategory> consultarCatalogoSubCategoriaOut) {
		...
		message.put("data", consultarCatalogoSubCategoriaOut);
		message.put("total", consultarCatalogoSubCategoriaOut.size());
	...
	public static String getResponseObj(CatalogSubCategory catalogoSubCategoriaOut) {
		String cadResponse = null;
		Map<String, Object> message = new HashMap<String, Object>();
		...
		json1.put("headerResponse", CommonRestOperations.headerResponseExito());
		json1.put("dataResult", message);
		message.put("data", catalogoSubCategoriaOut);
		message.put("total", 1);
		ObjectMapper mapper = new ObjectMapper();
		try {
			cadResponse = mapper.writeValueAsString(json1);
