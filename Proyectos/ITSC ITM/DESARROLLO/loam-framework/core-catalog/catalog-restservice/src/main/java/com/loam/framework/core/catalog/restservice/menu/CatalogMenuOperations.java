...
public class CatalogMenuOperations {
	public static String getResponse(List<CatalogMenu> consultarCatalogoMenuOut) {
		...
		message.put("data", consultarCatalogoMenuOut);
		message.put("total", consultarCatalogoMenuOut.size());
	...
	public static String getResponseObj(CatalogMenu catalogoMenuOut) {
		String cadResponse = null;
		Map<String, Object> message = new HashMap<String, Object>();
		...
		json1.put("headerResponse", CommonRestOperations.headerResponseExito());
		json1.put("dataResult", message);
		message.put("data", catalogoMenuOut);
		message.put("total", 1);
		ObjectMapper mapper = new ObjectMapper();
		try {
			cadResponse = mapper.writeValueAsString(json1);
